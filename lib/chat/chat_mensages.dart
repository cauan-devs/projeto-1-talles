                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.only(
                        left: 0, bottom: 100, top: 30, right: 180),
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.all(20),
                    child:  Text("hahaha não. Vai trabalhar"),
                  ),
                  Container(
                    width: 80,
                    height: 65,
                  ...
                  Container(
                    ...
                    margin:  EdgeInsetsDirectional.only(
                        end: 340, top: 50, start: 15),
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12.0),
                      color: Colors.greenAccent,
                    ),
                    padding: EdgeInsets.all(10),
                    child: Text("amanhã tu vem pra nois assistir a copa"),
                  ),
                  Container(
                    width: 200,
                    height: 80,
                    ...
                    padding: EdgeInsets.all(20),
                    child: Text("agora vi vantagem, chefia"),
                  ),
                ],
              ),
            ),
